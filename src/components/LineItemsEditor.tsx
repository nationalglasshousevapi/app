...
export default function LineItemsEditor({
  ...
  function MobileCard({ item, idx }: { item: LineItem; idx: number }) {
    ...
    return (
      <div className="rounded-xl p-3 border space-y-2 bg-slate-50/80 border-slate-100">
    ...
    <div className="space-y-3">
      ...
      <div className="hidden md:block overflow-x-auto">
        <div className="min-w-[640px] space-y-3">
          ...
          {items.map((item, idx) => {
            return (
            <div key={idx} className="grid grid-cols-12 gap-2 items-start rounded-xl p-4 border bg-slate-50/80 border-slate-100">
